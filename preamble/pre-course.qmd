...
## Create an account on the sandbox server

(Optional, possible?)

## Read up on functionals and functions

Intermediate course

## Read up on pipeline management with targets

Learn just target session of advanced course? (really will help make
course smoother)

## What are servers?

Some reading on the basics of server environments.

## Why use R in servers?

Strengths and weaknesses

## Opening up or setting up RStudio in the server

## Set up an RStudio Project in the server

(without help of r3 package?)

## Tracking changes with version control using Git

Read about Git (why not GitHub) (where to have remote?)

## Course basics

If you haven't read the syllabus in @sec-syllabus, **please read it
now**. Read over what the course will cover, what we expect you to learn
by the end of it, and what our basic assumptions are about who you are
and what you already know. At the end of this section, we'll ask you a
few questions to see if you understand what you'll learn in the course.
